...
| **P2b — remaining Performance metrics** | GMROI, broken-halo detection, archetype mix — emit as new card kinds via the same rail (no new plumbing) | `halo_pricing`, DHARAM | extends the panel |
