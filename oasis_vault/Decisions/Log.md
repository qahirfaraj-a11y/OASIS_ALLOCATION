...
- **Outcome**: Tree clean, both commits green on the targeted suites. **The site scoping is NOT live-verified** — Docker would not start, and two Odoo field names remain assumptions the stub shares with the code. Confirm them before relying on it. See [[OASIS_ERP_Agnostic_2026-08]].
